        ...
        <div className="w-full max-w-6xl mx-auto px-8 py-4 flex flex-1 gap-8 items-center">
           <Card className="w-full max-w-sm"> 
                  <div className='flex flex-col gap-5 justify-center w-full items-center'>
                    ...
                    <p className='text-sm text-muted-foreground'>Don't have an account? <span className='text-primary font-semibold cursor-pointer'>Register Now</span></p>
                  </div>
                       ...
                       <div>
                        ...
                        <div className='flex items-center w-full justify-between'>
                          <div className='flex items-center gap-2'>
                           ...
                           <p className='text-[1rem] leading-tight font-semibold text-primary'>Forgot Password?</p>
                        </div>
