           ...
           <Card className="rounded-lg ring-0 border">
              <div className="flex flex-col px-2">
                <p className="text-xl leading-tight font-semibold">Description</p>
                 <textarea className="ring ring-secondary h-32 w-full mt-4 outline-none p-2 rounded-lg placeholder:leading-tight placeholder:text-gray-500 placeholder:text-[0.9rem]" placeholder="Describe your task here.">
             ...
             <Card className="rounded-lg ring-0 border">
              <div className="flex flex-col px-2 gap-2">
                <p className="text-xl leading-tight font-semibold">Category</p>
                 <div className="flex items-center justify-between">
                   <p className="text-[1rem] text-gray-500 leading-tight">Development</p>
                   <ArrowDown className="size-5 text-gray-500"/>
                 </div>
              </div>
           </Card>
             ...
             <Card className="rounded-lg ring-0 border">
              <div className="flex flex-col px-2 gap-2">
                <p className="text-xl leading-tight font-semibold">Priority</p>
                 <div className="flex items-center justify-between">
                   <p className="text-[1rem] text-gray-500 leading-tight">Urgent</p>
                   <ArrowDown className="size-5 text-gray-500"/>
                 </div>
              </div>
           </Card>
